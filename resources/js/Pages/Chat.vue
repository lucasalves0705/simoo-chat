...
export default {
    ...
    methods: {
        ...
        loadMessages: async function (userId) {
            ...
            axios.get(`/usuarios/${userId}`).then(response => {
                this.userActive = response.data.user
            })

            await axios.get(`/mensagens/${userId}`).then(response => {
        ...
        sendMessage: async function () {
            ...
            await axios.post('/mensagens/store', {
                    ...
                    <div class="w-3/12 bg-gray-200 bg-opacity-25 border-r border-gray-200 overflow-y-auto">
                        <ul>
                            <li
                                ...
                                :class="(userActive && userActive.id == user.id) ? 'bg-gray-200' : ''"
                    ...
                    <div class="w-9/12 flex flex-col justify-between">
                        ...
                        <div class="w-full p-6 flex flex-col overflow-y-auto">
                            <div
                                ...
                                :key="message.id"
                                :class="(message.from != userActive.id) ? 'text-right': ''"
                                class="w-full mb-3 message">
                                <p
                                    :class="(message.from != userActive.id) ? 'bg-indigo-300 bg-opacity-25': 'bg-gray-300 bg-opacity-25;'"
                        ...
                        <div
                            ...
                            <form v-on:submit.prevent="sendMessage">
                                <div class="flex rounded-md overflow-hidden border border-gray-300">
                                    <input v-model="message" type="text" class="flex-1 px-4 py-2 text-sm focus:outline-none rounded-l-md">
